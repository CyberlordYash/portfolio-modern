...
const RecentProjects = () => {
  ...
  return (
    <section className="relative w-full overflow-hidden py-16 md:py-24 bg-[#ffffff] dark:bg-[#000000]">
      ...
      <div className="relative mx-auto max-w-[90vw] 2xl:max-w-[1400px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-px bg-black/8 dark:bg-white/8">
          ...
          <div className="lg:col-span-2 bg-[#ffffff] dark:bg-[#000000] p-px">
            <FeaturedCard {...p0} />
          </div>
          <div className="lg:col-span-1 bg-[#ffffff] dark:bg-[#000000] p-px">
            <MediumCard {...p1} delay={0.1} />
          </div>

          {/* Row 2: three equal medium cards */}
          {[p2, p3, p4].map((p, i) => (
            <div key={p.id} className="lg:col-span-1 bg-[#ffffff] dark:bg-[#000000] p-px">
              <MediumCard {...p} delay={0.07 + i * 0.07} />
            </div>
          ))}

          {/* Row 3: wide card full width */}
          <div className="lg:col-span-3 bg-[#ffffff] dark:bg-[#000000] p-px">
            <WideCard {...p5} />
          </div>
        </div>
