...
const iconMap: Record<string, React.ReactNode> = {
  ...
  "5": <PiFileSqlLight className="h-8 w-8 text-blue-400" />,
  "6": <FaNode className="h-8 w-8 text-blue-500" />,
  "7": <SiMongodb className="h-8 w-8 text-blue-500" />,
  "8": <SiGo className="h-8 w-8 text-sky-400" />,
  "9": <SiSpringboot className="h-8 w-8 text-blue-400" />,
