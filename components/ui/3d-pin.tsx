    ...
    >
      ...
      >
        <div
          ...
          className="  dark:bg-gradient-to-br from-[rgba(75,30,133,1)] to-[rgba(75,30,133,0.01)] absolute left-1/2 p-6 top-1/2  flex justify-start items-start  rounded-md  shadow-[0_4px_4px_rgb(0_0_0/0.4)] border border-white/[0.1] group-hover/pin:border-white/[0.2] transition duration-700 overflow-hidden "
        >
  ...
  return (
    <motion.div className="  pointer-events-none  w-full h-80 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500">
      <div className=" w-full h-full -mt-7 flex-none  inset-0">
        <div className=" bg-black-100 absolute top-0 inset-x-0  flex justify-center">
          <a
            href={href}
            target={"_blank"}
        ...
        >
          <>
            <motion.div
              ...
              className="absolute left-1/2 top-1/2  h-[11.25rem] w-[11.25rem] rounded-[50%] bg-green-500/[0.8] shadow-[0_8px_16px_rgb(0_0_0/0.4)]"
            ></motion.div>
            <motion.div
              initial={{
                opacity: 0,
