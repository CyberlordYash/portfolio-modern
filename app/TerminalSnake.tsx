  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-2 px-4 py-2 rounded-xl bg-blue-500/10 hover:bg-blue-500/20 border border-blue-500/20 transition-all"
      >
            ...
            >
              ...
              <div className="p-4 border-b border-neutral-100 dark:border-white/5 flex justify-between items-center bg-neutral-50 dark:bg-white/[0.02]">
                <div className="flex gap-1.5">
                  ...
                  <div className="w-3 h-3 rounded-full bg-blue-500/20 dark:bg-blue-500/40" />
                </div>
              ...
              <div className="flex divide-x divide-neutral-100 dark:divide-white/5 border-b border-neutral-100 dark:border-white/5">
                ...
                <div className="flex-1 p-3 text-center">
                  ...
                  <p
                    className={`text-sm font-bold ${latency > 150 ? "text-red-500" : "text-blue-500"}`}
                  >
                    {latency}ms
                  </p>
                </div>
              ...
              >
                ...
                {packets.map((p) => (
                  <motion.div
                    key={p.id}
                    className="absolute w-2 h-2 bg-blue-500 rounded-full shadow-[0_0_8px_#91919A]"
                ...
                {/* Server (Player) */}
                <div
                  className="absolute bottom-10 w-24 h-4 -translate-x-12 rounded-full bg-white dark:bg-blue-500 border border-blue-400 shadow-[0_0_20px_rgba(255,255,255,0.5)] transition-all duration-75 flex items-center justify-center"
