...
const FooterTerminal = () => {
  ...
  const cls = (c: string) => {
    switch (c) {
      ...
      case "nf-title":  return "text-blue-300 font-bold";
    ...
    >
      <div
        className={cn(
          ...
          "shadow-[0_0_80px_-20px_rgba(59,130,246,0.22),0_0_20px_-5px_rgba(59,130,246,0.06)]",
      ...
      >
        ...
        {/* Header */}
        <div className="relative z-10 flex shrink-0 items-center justify-between border-b border-blue-500/10 bg-[#03060d] px-4 py-2.5">
        ...
        {/* Status bar */}
        <div className="relative z-10 flex shrink-0 items-center justify-between border-t border-blue-500/10 bg-[#020409] px-4 py-1.5 text-[9px] text-neutral-700">
          <div className="flex items-center gap-3">
